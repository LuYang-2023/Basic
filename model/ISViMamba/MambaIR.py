...
'''
https://blog.csdn.net/weixin_43312117/article/details/138316513
'''
import warnings
...
class VSSBlock(nn.Module):
    ...
    def forward(self, input, x_size):
        ...
        ###wo
        x = x.contiguous().view(B, int(math.sqrt(L)),int(math.sqrt(L)), C)
        return x
...
if __name__ == '__main__':
    ...
    block = VSSBlock(hidden_dim=256, drop_path=0.1, attn_drop_rate=0.1, d_state=16, expand=2.0, is_light_sr=False)
